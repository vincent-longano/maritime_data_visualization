...
*/
export class PublicIndividualDwellTimeTableColumnSortInfo {
    /**
    * The id of the column to sort on
    */
    'columnId': PublicIndividualDwellTimeTableColumnSortInfo.ColumnIdEnum;
    /**
    * The order in which the column must be sorted
    */
    'sortOrder': PublicIndividualDwellTimeTableColumnSortInfo.SortOrderEnum;
...
export namespace PublicIndividualDwellTimeTableColumnSortInfo {
    export enum ColumnIdEnum {
        AreaName = <any> 'AREA_NAME',
        AssetId = <any> 'ASSET_ID',
        EnterCount = <any> 'ENTER_COUNT',
        FirstTimeInside = <any> 'FIRST_TIME_INSIDE',
        LastTimeInside = <any> 'LAST_TIME_INSIDE',
        DwellTime = <any> 'DWELL_TIME',
        CumulativeDwellTime = <any> 'CUMULATIVE_DWELL_TIME'
    }
