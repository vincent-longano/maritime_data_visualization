...
*/
export class PublicVisualAnalyticsTableProperties {
    /**
    * The ids of the columns that should be included in the table (ordered).
    */
    'columns': Array<string>;
    /**
    * The number of rows the table should show on a single page
    */
    ...
    */
    'sortInformation': Array<PublicVisualAnalyticsTableColumnSortInfo>;
